...
export default function EmailChange() {
  return (
    <div className="border-[1px] border-green-500 hover:border-black h-full w-full hover:cursor-pointer bg-white transition duration-300 hover:bg-black rounded-3xl overflow-hidden group relative p-4">
